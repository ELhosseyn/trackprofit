...
This app includes advanced performance optimization scripts to ensure the best user experience:

### Asset Optimization

To optimize assets for production:
...
- Runs component-specific optimizations

### ZRExpress Optimization

The ZRExpress component has been specifically optimized for performance:

```shell
node scripts/optimize-zrexpress.js
```
...
- Fixed duplicate code and redeclaration issues
...
```shell
node scripts/test-zrexpress-perf.js
```
...
The optimization target is to achieve <8ms loading time for lazy-loaded components.

### Performance Monitoring

For production builds, a performance monitoring script is automatically injected to track:
